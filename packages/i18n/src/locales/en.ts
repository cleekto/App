...
export const en = {
  ...
  property: {
    ...
    conditionOptions: {
      ...
      old_renovated: 'Old renovation',
      ongoing_renovation: 'Renovation in progress',
      needs_renovation: 'Needs renovation',
      white_frame: 'White frame',
      black_frame: 'Black frame',
      green_frame: 'Green frame',
      white_plus: 'White plus',
    },
    buildingStatusOptions: {
      old_build: 'Old building',
    ...
    projectTypeOptions: {
      ...
      duplex: 'Duplex',
      triplex: 'Triplex',
      m2_complex: 'm2 complex',
      optima_m2: 'OPTIMA by m2',
  ...
  task: {
    ...
    add: 'New task',
    addFailed: 'Could not create the task',
    noProperties: 'A task belongs to a property, and there are none yet',
    calendar: 'Calendar',
