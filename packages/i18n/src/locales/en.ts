...
export const en = {
  app: {
    ...
    headline: 'Turn property listings into deals.',
    supporting: 'Everything an agency needs: properties, owners and deals in one workspace.',
    chainProperty: 'Property',
    chainClient: 'Client',
    chainDeal: 'Deal',
    welcomeBack: 'Welcome back',
    welcomeHint: 'Sign in to your agency workspace.',
    previewDeals: 'deals',
    previewLeads: 'properties',
    previewPipeline: 'Pipeline',
    previewActivity: 'Recent activity',
    previewNewProperty: 'New property',
    previewOwnerCalled: 'Owner agreed',
    previewPublished: 'Listing published',
  },
  health: {
  ...
  chat: {
    ...
    emptyRoomsHint: 'A manager or admin creates rooms — say, “General” or “Vake”.',
    ...
    emptyConversationsHint: 'Pick a colleague to start. Only the two of you see it.',
    privateHint: 'Private conversation. Nobody but the two of you can see it.',
  },
  ...
  activityAction: {
    ...
    CHAT_ROOM_UPDATED: 'Chat room changed',
