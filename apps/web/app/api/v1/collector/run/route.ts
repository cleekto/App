 ...
 *
 *   30 5 * * *  — 09:30 по Тбилиси, утреннее окно;
 *   0 11 * * *  — 15:00 по Тбилиси, дневное.
 *
 * Окна заданы владельцем 2026-09-07. Сдвиг ровно четыре часа и не меняется
 * в течение года: Грузия перевод часов отменила. Будь иначе, окна уезжали
 * бы дважды в год, и заметили бы это не сразу.
 *
 * ПОЧЕМУ ПО ОДНОМУ ПРОГОНУ НА ОКНО, А НЕ КАЖДЫЕ 15 МИНУТ. Аккаунт Vercel
 * на тарифе Hobby: там разрешено два задания, каждое не чаще раза в сутки.
 * Выкладка с более частым расписанием отклоняется прямой ошибкой площадки —
 * «Hobby accounts are limited to daily cron jobs». Двух прогонов хватает
 * на оба окна; более частый сбор потребует либо тарифа Pro, либо внешнего
 * планировщика.
 *
