...
export class ApiClient {
   ...
   *
   * Контакт не передаётся и передаваться не может: объявление выходит под
   * именем и номером того, кто его размещает, а это известно серверу
   * из сессии. §6А.7 требует «одного клика» — выбирать тут и нечего.
   */
